...
#python3 /opt/app/manage.py clear_cache
#python3 /opt/app/manage.py makemigrations
#python3 /opt/app/manage.py migrate
rm -rf /opt/app/static/*
#python3 /opt/app/manage.py collectstatic

#chown -R unit:unit /opt/app

mkdir /opt/unit
mkdir -p /opt/unit/state/certs/

UNIT_CONFIG="/etc/unit/unit.json"
